...
export function resetOffset() { currentOffset = 0; }
export function setCurrentDays(d) { currentDays = d; }
export function incrementOffset(delta) { currentOffset = Math.max(0, currentOffset + delta); }
